    ...
    <div>
      ...
      <div className="mt-3 flex gap-2">
        ...
        <button
          ...
          disabled={busy}
          className="inline-flex flex-1 items-center justify-center gap-2 rounded-md bg-ink px-3 py-2 font-medium text-surface text-sm transition hover:opacity-90 disabled:opacity-60"
        >
