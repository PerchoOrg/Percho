...
- **"What matters more to you?" is back in the feed, and it finally looks like the rest of it.** Every ninth card asks you to choose between two things — room to grow or nothing to fix, a bigger yard or a shorter drive. The card splits in two and each side shows the room that actually makes the point: "Move-in ready" shows a real kitchen, not another photo of a house from the street. Under it, a plain description of what's in the picture and how many homes in your feed are on that side, with what they typically cost. Choices about a neighbourhood rather than a house show the neighbourhood instead; a side we have no honest photo for stays plain rather than borrowing an unrelated one. Swipe toward the one you want — the side you're picking opens up and the other steps back
