...
window.SWIPE_FEED = window.LISTINGS.map((L, i) => ({
  ...
  community: ["Bridle Trails", "Houghton", "Medina", "Madison Park", "Clyde Hill", "Downtown Kirkland"][i % 6],
  schools: ["Bellevue HS · 9", "Lake WA HS · 10", "Bellevue HS · 9", "Garfield HS · 8", "Bellevue HS · 9", "Lake WA HS · 10"][i % 6],
  commute: ["18m to Microsoft", "22m to SLU", "14m to Microsoft", "11m to Downtown", "16m to Microsoft", "19m to SLU"][i % 6],
}));
