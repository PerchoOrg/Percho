...
内容迁至 `docs/pipelines/` 目录下 7 份专项文档 + `README.md` 总纲(2026-07-16 拆分)。
...
- [`video-nearby-narrative.md`](./video-nearby-narrative.md) — nightlife
- [`video-nearby-magazine.md`](./video-nearby-magazine.md) — kids, asian_community, faith
- [`video-nearby-map.md`](./video-nearby-map.md) — outdoor, transit, work_hubs

历史 DEVLOG 引用 `video-generation-master.md` 保留此 stub 兼容,不要再往这里写内容。
