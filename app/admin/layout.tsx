 ...
 * bar. Phase 104 (2026-07-17): split Nearby into two tabs — Home
 * (per-listing) and Neighborhood (per-community). Six tabs now.
 */

import { requireAdmin } from '@/lib/auth/require-admin';
import { Activity, Building2, Film, Home, ImageIcon, ListVideo } from 'lucide-react';
