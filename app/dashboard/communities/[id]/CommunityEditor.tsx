 ...
 * (2026-06-22) flattened.
 *
 * Phase 50 changes:
 *   - Removed the inner `<section>` wrapper + duplicate "Community details"
 *     heading. The page-level details panel is now the sole framing card,
 *     mirroring how the listing edit page renders EditListingForm.
 *   - DangerZone moved out — page.tsx renders it as a sibling section at the
 *     bottom of the Details tab, same shape as the listing DangerZone.
 *
 * The form itself (auto-saved metadata edit with inline validation errors) is
 * unchanged.
 */
