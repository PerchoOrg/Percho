  ...
  return (
    <section className="rounded border border-bronze/30 bg-ink2 p-6">
      <div className="mb-4 flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
        ...
        <span className="text-cream/50 text-xs">Coming soon — Q4 2026</span>
      </div>

      <p className="mb-4 text-cream/70 text-sm leading-relaxed">
      ...
      <button
        ...
        aria-disabled="true"
        className="inline-flex items-center gap-2 rounded-md border border-cream/15 bg-ink/40 px-4 py-2 text-cream/50 text-sm"
      >
